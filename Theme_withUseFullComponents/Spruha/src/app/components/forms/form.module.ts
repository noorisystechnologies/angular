...
@NgModule({
  declarations: [ FormElementsComponent, FormAdvancedComponent, FormLayoutsComponent, FormValidationComponent, FormWizardsComponent, FormEditorsComponent, FormElementSizesComponent],
  imports: [
    CommonModule,
    FormRoutingModule,
    FormsModule,
