...
export class BuySellComponent implements OnInit {
  constructor(){
    ...
    let selectInput = document.querySelectorAll('ng-select')
    let selectContainer = document.querySelectorAll('.ng-select-container')

    selectInput[0].addEventListener('keydown', ()=>{}, {passive:true})
