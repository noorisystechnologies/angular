...
`<div class="btn btn-list">
    ...
    <div aria-label="Basic example" class="btn btn-group" role="group">
        <button class="btn ripple btn-secondary btn-icon active" type="button">
            <i class="typcn typcn-media-play-outline"></i>
        </button>
        <button class="btn ripple btn-secondary btn-icon" type="button">
    ...
    <div aria-label="Basic example" class="btn btn-group" role="group">
        <button class="btn ripple btn-primary btn-icon active" type="button">
            <i class="typcn typcn-media-play-outline"></i>
        </button>
        <button class="btn ripple btn-primary btn-icon" type="button">
            <i class="typcn typcn-media-pause-outline"></i>
        </button>
        <button class="btn ripple btn-primary btn-icon" type="button">
            <i class="typcn typcn-media-stop-outline"></i>
...
export let buttonsHTML10 = 
`<div class="btn btn-list">
    <span ngbDropdown>
        <button class="btn ripple btn-primary" ngbDropdownToggle>Dropdown 
            <i class="icon ion-ios-arrow-down tx-11 mg-l-3"></i>
        </button>
        <div ngbDropdownMenu>
            <a class="dropdown-item" href="javascript:;">Profile</a>
            <a class="dropdown-item" href="javascript:;">Activity Logs</a>
            <a class="dropdown-item" href="javascript:;">Account Settings</a>
            <a class="dropdown-item" href="javascript:;">Logout</a>
        </div>
    </span>
    <span ngbDropdown>
        <button class="btn ripple btn-secondary" ngbDropdownToggle>Dropdown 
            <i class="icon ion-ios-arrow-down tx-11 mg-l-3"></i>
        </button>
        <div ngbDropdownMenu>
            <a class="dropdown-item" href="javascript:;">Profile</a>
